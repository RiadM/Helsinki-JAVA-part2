...
public class MovingTest<_Thing, _Item, _Laatikko, _Packer> {
    ...
    String thingString = "Thing";
    String itemString = "Item.java";
    String boxString = "Box";
    ...
    public void hasThingInterface() {
        ...
        try {
            ...
            fail("Create package moving.domain.domain and inside it, create interface Thing");
        }

        if (clazz == null) {
            fail("Have you created public interface Thing inside the package moving.domain.domain?");
        }
    ...
    public void testItemConstructor() throws Throwable {
        ...
        String v = "error caused by code new Item.java(\"Olutkori\", 10);";
    ...
    public void classItemImplementsInterfaceThing() {
        ...
        if (!toteuttaaRajapinnan) {
            fail("Does the class Item.java implement interface Thing?");
        }
    }
    ...
    public void itemGetVolume() throws Throwable {
        ...
        String v = "Item.java item = new Item.java(\"Olutkori\", 10); \n"
                + "item.getVolume();\n";
        ...
        String v2 = "Item.java item = new Item.java(\"Computer\", 3); \n"
                + "item.getVolume();\n";
    ...
    public void itemToString() throws Throwable {
        ...
        _Item item = newItem("Olutkori", 10);
        assertFalse("Create method toString for class Item.java as specified in the assignment", item.toString().contains("@"));
    ...
    public void itemComparable() {
        ...
        if (!toteuttaaRajapinnan) {
            fail("Does the class Item.java implement interface Comparable<Item.java>?");
        }
    ...
    public void itemCompareTo() throws Throwable {
        ...
        String v = "Item.java item1 = new Item.java(\"Olutkori\", 10); \n"
                + "Item.java item2 = new Item.java(\"Computer\", 3);\n"
                + "item1.compareTo(item2);\n";

        assertTrue("Class " + klassName + " should have method public int compareTo(Item.java comparable)",
        ...
        v = "Item.java item1 = new Item.java(\"Olutkori\", 10); \n"
                + "Item.java item2 = new Item.java(\"Computer\", 3);\n"
    ...
    public void itemCompareToWorks() {
        ...
        if (!toteuttaaRajapinnan) {
            fail("Does the class Item.java implement interface Comparable?");
        }
        ...
        try {
            ...
            fail("Does calling method compareTo of class Item.java work?");
        }

        if (ret <= 0) {
            fail("Does method compareTo of class Item.java sort items into a descending order?\n"
                    + "try codea\n"
                    + "Item.java item1 = new Item.java(\"stone\", 5); \n"
                    + "Item.java item2 = new Item.java(\"record\", 2); \n"
                    + "item1.compareTo(item2)");
        }
        ...
        if (ret >= 0) {
            fail("Does method compareTo of class Item.java sort items into a descending order?\n"
                    + "try codea\n"
                    + "Item.java item1 = new Item.java(\"stone\", 5); \n"
                    + "Item.java item2 = new Item.java(\"record\", 7); \n"
                    + "item1.compareTo(item2)");
        }
        ...
        if (ret != 0) {
            fail("Does method compareTo of class Item.java sort items into a descending order so that items that have equal volume are in the same place?\n"
                    + "try codea\n"
                    + "Item.java item1 = new Item.java(\"stone\", 5); \n"
                    + "Item.java item2 = new Item.java(\"record\", 5); \n"
                    + "item1.compareTo(item2)");
        }
    }
    ...
    public void boxMethodAdd() throws Throwable {
        ...
        String v = "Box box = new Box(1000);\n"
                + "Item.java item = new Item.java(\"Olutkori\", 10);\n"
                + "box.addThing( item );\n";
        ...
        v = "Box box = new Box(1000);\n"
                + "Item.java item = new Item.java(\"Stone\", 1001); \n"
                + "box.addThing( item );\n";
    ...
    public void boxIsThing() {
        ...
        if (boxClass == null) {
            fail("Have you created public class Box inside the package moving.domain.domain?");
        }
    ...
    public void boxGetVolume() throws Throwable {
        ...
        v = "Box box = new Box(1000);\n"
                + "box.addThing( new Item.java(\"Olutkori\", 10); )\n"
                + "box.addThing( new Item.java(\"Stone\", 5); )\n"
                + "box.getVolume(  );\n";
    ...
    public void packerMethodPackThings() throws Throwable {
        ...
        String v = "Packer packer = new Packer(1000);\n"
                ...
                + "things.add( new Item.java(\"Olutkori\", 10) );\n"
                + "things.add( new Item.java(\"Stone\", 5) );\n"
                + "things.add( new Item.java(\"Taulu\", 20) );\n"
    ...
    public void packerWorks() throws Throwable {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            itemMj += " things.add( new Item.java(\"Stone\", " + til + ") );\n";
            itemet.add(e);
        }
    ...
    private int getVolume(_Laatikko box) throws Throwable {
        ...
        _LaatikkoRef = Reflex.reflect(klassName);
        String v = "Box box = new Box(1000);\n"
                + "box.addThing( new Item.java(\"stone\",1));\n"
                + "box.getVolume();\n";
